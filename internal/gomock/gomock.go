...
//
//	mockgen -destination=internal/gomock/gomock.go -source=internal/repository/Store.go Store
//
...
func (m *MockStore) CreateAccount(ctx context.Context, arg pkg.CreateAccountParams) (models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(ctx context.Context, arg pkg.CreateEntryParams) (models.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateTransfer(ctx context.Context, arg pkg.CreateTransferParams) (models.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccount(ctx context.Context, id int64) (models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(ctx context.Context, id int64) (models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(ctx context.Context, id int64) (models.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(ctx context.Context, arg pkg.ListAccountsParams) ([]models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(ctx context.Context, arg pkg.TransferTxParams) (pkg.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", ctx, arg)
	ret0, _ := ret[0].(pkg.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) UpdateAccount(ctx context.Context, arg pkg.UpdateAccountParams) (models.Account, error) {
	m.ctrl.T.Helper()
